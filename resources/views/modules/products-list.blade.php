...
@section('content')
    <div>
        ...
        <div class="mb-6 bg-white rounded-lg shadow-sm border border-gray-100 p-4">
            <form action="{{ route('products.index') }}" method="GET" class="flex gap-3 items-center flex-wrap">
                <div class="flex-1 min-w-64">
                    <div class="relative">
                        <i class="fas fa-search absolute left-3 top-3 text-gray-400"></i>
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by product name, code, or barcode..."
                ...
                <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-lg font-semibold transition-colors flex items-center gap-2">
                    <i class="fas fa-search"></i>Search
                </button>
                @if(request('search'))
                    <a href="{{ route('products.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-900 px-6 py-2.5 rounded-lg font-semibold transition-colors flex items-center gap-2">
