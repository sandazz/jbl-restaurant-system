...
<div>
    ...
    <div class="mb-8 flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-500 mt-1 text-sm">Fill in the details below to add a new product.</p>
        </div>
    </div>

    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="max-w-3xl mx-auto space-y-6">
        @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="discount" id="discount" value="{{ old('discount') }}" step="0.01" min="0" max="100"
                                class="w-full pl-4 pr-9 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500"
                                placeholder="0">
                ...
                <label class="flex items-center gap-2.5 cursor-pointer select-none">
                    ...
                    <div class="relative">
                        <input type="checkbox" name="is_unlimited_stock" id="is_unlimited_stock" value="1"
                            {{ old('is_unlimited_stock') ? 'checked' : '' }} class="sr-only peer">
            ...
            <div id="stock-fields" class="p-6">
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="low_stock_limit" id="low_stock_limit" value="{{ old('low_stock_limit', 0) }}" min="0"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500"
                            placeholder="e.g. 5">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <button type="button" id="remove-image" class="hidden mt-3 text-xs text-gray-500 hover:text-red-600 transition-colors"
            ...
            <div class="p-6">
                <div class="flex gap-4">
                    <label class="relative cursor-pointer flex-1">
                        <input type="radio" name="status" value="active" class="sr-only peer" {{ old('status', 'active') === 'active' ? 'checked' : '' }}>
                    ...
                    <label class="relative cursor-pointer flex-1">
                        <input type="radio" name="status" value="inactive" class="sr-only peer" {{ old('status') === 'inactive' ? 'checked' : '' }}>
