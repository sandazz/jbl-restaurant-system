                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="selling_price" id="selling_price" value="{{ old('selling_price', $product->selling_price) }}" step="0.01" min="0" required
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 {{ $errors->has('selling_price') ? 'border-red-400 bg-red-50' : '' }}" placeholder="0.00">
                        </div>
